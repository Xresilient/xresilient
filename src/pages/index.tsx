...
const Index = () => {
  ...
  return (
    ...
    >
      <section
        id="home"
        className={`bg-black min-h-screen w-full px-4 lg:px-[8%] flex flex-col items-center ${styles.linebg}`}
      >
        <div
          className={`flex flex-col items-center w-full md:w-[50%] justify-center gap-16 mt-20`}
          data-aos="zoom-in"
          data-aos-duration="600"
        >
          <h3 className="text-center text-5xl md:text-5xl text-white font-bold font-spGrotesk">
      ...
      <section
        id="services"
        className={`bg-black min-h-screen w-full px-4 lg:px-[8%] flex flex-col mt-10 md:mt-44 gap-20 pb-40 ${styles.revlinebg}`}
      >
      ...
      <section
        ...
        id="contact"
      >
        <div className="flex flex-col items-center w-full justify-center gap-40 border-4 border-primary rounded-2xl pt-8 px-4 md:px-20 pb-20">
          <h2 className="text-white text-4xl md:text-6xl font-extrabold font-chillax text-center">
            Contact Us
          </h2>
          <div className="flex flex-col md:flex-row md:gap-20 gap-8 w-full">
            <div
              ...
              data-aos-duration="600"
            >
              <h3 className="text-white text-2xl md:text-4xl font-extrabold font-chillax pl-9">
                Let&apos;s discuss on <br />something
                <span className="text-primary"> cool</span> <br />together
              </h3>
              <span className="text-white text-xl md:text-2xl font-bold p-8">
                <HiMail className="text-primary text-1xl inline-block mr-2" />
                sxtitsolutions@gmail.com
              </span>
              <span className="text-white text-xl md:text-2xl font-bold p-4 border-4 border-primary rounded-2xl bg-primary/20 w-3/5 ml-6">
                <HiPhone className="text-primary text-3xl inline-block mr-2" />
                +91 9325831463
                {/*<br /><br /><HiPhone className="text-primary text-3xl inline-block mr-2" />
                +91 9325831463*/}
              </span>
              <span className="text-white text-xl md:text-2xl font-bold p-4 border-4 border-primary rounded-2xl bg-primary/20 w-3/5 ml-6">
                <HiPhone className="text-primary text-3xl inline-block mr-2" />
            ...
            <div
              className="flex flex-col gap-4 bg-white rounded-2xl p-8 w-full border-primary border-4 md:w-1/2"
              data-aos="fade-up"
              data-aos-duration="600"
            >
