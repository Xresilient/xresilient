...
const AboutCard = ({
  ...
  return (
    <div className="flex flex-col items-center w-full h-full" {...rest}>
      ...
      <div className="flex flex-col items-center justify-center w-full h-full bg-black rounded-2xl border-4 border-primary p-4 gap-6">
        <h4 className="text-white text-2xl font-bold text-center font-chillax">{name}</h4>
